...
public sealed class SpecSemanticSearchService
{
    ...
    private readonly ISpecSemanticEmbeddingCache _specEmbeddingCacheService;
    private readonly ILogger<SpecSemanticSearchService> _logger;

    public SpecSemanticSearchService(
        IUnitOfWork unitOfWork,
        IEmbeddingService embeddingService,
        ISpecSemanticEmbeddingCache specEmbeddingCacheService,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var baseQuery = SpecDataScopeRules.ApplyScopeToQuery(
