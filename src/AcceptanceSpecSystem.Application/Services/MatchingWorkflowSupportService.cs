...
public readonly record struct WriteBackSummary(int RequestedCells, int WrittenCells);
public readonly record struct RenderedWriteBackFile(byte[] Content, WriteBackSummary Summary);
