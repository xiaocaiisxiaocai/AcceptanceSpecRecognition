...
public sealed class MatchingPreviewAppService
{
    ...
    private async Task<MatchingConfig> ConvertToMatchingConfigAsync(MatchConfigDto? dto)
    {
        ...
        return new MatchingConfig
        {
            ...
            RecallTopK = Math.Clamp(dto?.RecallTopK ?? defaultRecallTopK, 1, 20),
            ...
            LlmEntityResolutionTopCandidates = Math.Clamp(dto?.LlmEntityResolutionTopCandidates ?? fallbackConfig.LlmEntityResolutionTopCandidates, 1, 10),
