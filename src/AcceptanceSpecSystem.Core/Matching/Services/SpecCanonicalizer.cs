...
public sealed class SpecCanonicalizer : ISpecCanonicalizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> BrandNormMap =
        ...
        {
            // 日系
            ["松下"] = "Panasonic", ["panasonic"] = "Panasonic",
            ["ABB"] = "ABB", ["abb"] = "ABB", ["阿西布朗"] = "ABB",
            ["欧姆龙"] = "Omron",   ["omron"] = "Omron",
            ["三菱"] = "Mitsubishi", ["mitsubishi"] = "Mitsubishi",
            ["基恩士"] = "Keyence", ["keyence"] = "Keyence",
            ["安川"] = "Yaskawa",   ["yaskawa"] = "Yaskawa",
            ["发那科"] = "Fanuc",   ["fanuc"] = "Fanuc",
            ["日本电产"] = "Nidec", ["nidec"] = "Nidec",
            ["富士"] = "Fuji",      ["fuji"] = "Fuji",
            ["东芝"] = "Toshiba",   ["toshiba"] = "Toshiba",
            ["日立"] = "Hitachi",   ["hitachi"] = "Hitachi",
            ["SMC"] = "SMC",        ["smc"] = "SMC",
            ["CKD"] = "CKD",        ["ckd"] = "CKD",
            ["费斯托"] = "Festo",    ["festo"] = "Festo",
            ["亚德客"] = "Airtac",   ["airtac"] = "Airtac",
            ["MISUMI"] = "Misumi",  ["misumi"] = "Misumi", ["米思米"] = "Misumi",
            ["上银"] = "HIWIN",      ["hiwin"] = "HIWIN",
            ["THK"] = "THK",         ["thk"] = "THK",
            ["IAI"] = "IAI",         ["iai"] = "IAI",
            // 欧系
            ["施耐德"] = "Schneider", ["schneider"] = "Schneider",
            ["西门子"] = "Siemens",   ["siemens"] = "Siemens",
            ["博世"] = "Bosch",       ["bosch"] = "Bosch",
            ["力士乐"] = "Rexroth",    ["rexroth"] = "Rexroth",
            ["菲尼克斯"] = "Phoenix",  ["phoenix"] = "Phoenix",
            ["皮尔磁"] = "Pilz",      ["pilz"] = "Pilz",
            ["倍福"] = "Beckhoff",    ["beckhoff"] = "Beckhoff",
            ["倍加福"] = "Pepperl-Fuchs", ["pepperl-fuchs"] = "Pepperl-Fuchs",
            ["Pepperl Fuchs"] = "Pepperl-Fuchs", ["pepperl fuchs"] = "Pepperl-Fuchs",
            ["图尔克"] = "Turck",      ["turck"] = "Turck",
            ["西克"] = "Sick",         ["sick"] = "Sick",
            ["易福门"] = "IFM",        ["ifm"] = "IFM",
            ["巴鲁夫"] = "Balluff",    ["balluff"] = "Balluff",
            ["台达"] = "Delta",       ["delta"] = "Delta",
            ["魏德米勒"] = "Weidmuller", ["weidmuller"] = "Weidmuller",
            // 美系
            ["艾伦-布拉德利"] = "Allen-Bradley", ["allen-bradley"] = "Allen-Bradley",
            ["罗克韦尔"] = "Rockwell", ["rockwell"] = "Rockwell",
            ["爱默生"] = "Emerson",    ["emerson"] = "Emerson",
            ["霍尼韦尔"] = "Honeywell", ["honeywell"] = "Honeywell",
            ["邦纳"] = "Banner",      ["banner"] = "Banner",
            ["康耐视"] = "Cognex",     ["cognex"] = "Cognex",
            ["派克"] = "Parker",       ["parker"] = "Parker",
            ["英飞凌"] = "Infineon",   ["infineon"] = "Infineon",
            // 韩系
            ["三星"] = "Samsung",     ["samsung"] = "Samsung",
            ["LG"] = "LG",            ["lg"] = "LG",
            ["现代"] = "Hyundai",     ["hyundai"] = "Hyundai",
            // 台系
            ["研华"] = "Advantech",   ["advantech"] = "Advantech",
            ["威纶通"] = "Weintek",   ["weintek"] = "Weintek",
            // 视觉/机器人
            ["巴斯勒"] = "Basler",     ["basler"] = "Basler",
            ["海康机器人"] = "Hikrobot", ["hikrobot"] = "Hikrobot",
            ["大恒"] = "Daheng",       ["daheng"] = "Daheng",
            ["库卡"] = "Kuka",         ["kuka"] = "Kuka",
            ["川崎"] = "Kawasaki",     ["kawasaki"] = "Kawasaki",
            ["爱普生"] = "Epson",      ["epson"] = "Epson",
            ["优傲"] = "Universal Robots", ["universal robots"] = "Universal Robots",
            ["史陶比尔"] = "Staubli",  ["staubli"] = "Staubli",
            // 国产自动化/视觉/机器人
            ["汇川"] = "Inovance", ["inovance"] = "Inovance",
            ["英威腾"] = "INVT", ["invt"] = "INVT",
            ["雷赛"] = "Leadshine", ["leadshine"] = "Leadshine",
            ["新时达"] = "STEP", ["step"] = "STEP",
            ["禾川"] = "HCFA", ["hcfa"] = "HCFA",
            ["众为兴"] = "Adtech", ["adtech"] = "Adtech",
            ["固高"] = "Googoltech", ["googoltech"] = "Googoltech",
            ["正运动"] = "Zmotion", ["zmotion"] = "Zmotion",
            ["奥普特"] = "OPT", ["opt"] = "OPT",
            ["迈德威视"] = "MindVision", ["mindvision"] = "MindVision",
            ["遨博"] = "Aubo", ["aubo"] = "Aubo",
            ["节卡"] = "Jaka", ["jaka"] = "Jaka",
            ["大族机器人"] = "Han's Robot", ["大族"] = "Han's Robot", ["han"] = "Han's Robot", ["han's robot"] = "Han's Robot",
            ["图漾"] = "Percipio", ["percipio"] = "Percipio",
            ["华睿"] = "Huaray", ["huaray"] = "Huaray",
            ["镭神"] = "Leishen", ["leishen"] = "Leishen",
            ["埃斯顿"] = "Estun", ["estun"] = "Estun",
            ["越疆"] = "Dobot", ["dobot"] = "Dobot",
            ["梅卡曼德"] = "Mech-Mind", ["mech-mind"] = "Mech-Mind", ["mech mind"] = "Mech-Mind",
        };
    ...
    private static readonly IReadOnlyDictionary<string, string> SynonymMap =
        ...
        {
            // 比较符同义（多字或符号，无歧义，安全）
            ["不超过"] = "≤", ["不大于"] = "≤", ["小于等于"] = "≤", ["小于或等于"] = "≤", ["不多于"] = "≤", ["<="] = "≤", ["=<"] = "≤", ["≦"] = "≤",
            ["不低于"] = "≥", ["不小于"] = "≥", ["大于等于"] = "≥", ["大于或等于"] = "≥", ["不少于"] = "≥", [">="] = "≥", ["=>"] = "≥", ["≧"] = "≥",
            ["约等于"] = "≈", ["近似等于"] = "≈", ["~="] = "≈", ["≅"] = "≈", ["≒"] = "≈",
            ["不等于"] = "≠", ["!="] = "≠", ["<>"] = "≠",
            ["小于"] = "<", ["大于"] = ">",
            // 公差正负号符号统一（符号，安全）
