...
<template>
  <div class="match-preview-data-table">
    <div class="match-preview-data-table__body">
      <el-table
          ...
          <template #default="{ row }">
            <div class="ai-status-cell">
              <el-tag
                ...
                :class="{
                  'ai-streaming': getReviewStatus(row) === 'streaming'
                }"
              >
...
<style scoped>
.match-preview-data-table__body {
  flex: 1 1 0;
  height: 0;
  min-height: 0;
  overflow: hidden;
...
.match-preview-data-table__body :deep(.el-table__body-wrapper) {
  overscroll-behavior: contain;
}

.match-preview-data-table__body :deep(.el-table .el-table__cell) {
  padding: 4px 0;
}

.match-preview-data-table__body :deep(.el-table .cell) {
  line-height: 1.35;
}
