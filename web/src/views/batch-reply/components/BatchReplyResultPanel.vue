  ...
  <el-card class="section-card file-stage-panel" shadow="never">
    ...
    <template v-else>
      ...
      <el-table class="preview-table" :data="resultFiles" border>
        <el-table-column prop="fileName" label="文件名" min-width="min(280px, calc(100vw - 32px))" />
        <el-table-column label="结果" width="min(120px, calc(100vw - 32px))" align="center">
        ...
        <el-table-column prop="message" label="说明" min-width="min(320px, calc(100vw - 32px))" />
      </el-table>
    </template>
  </el-card>
</template>
