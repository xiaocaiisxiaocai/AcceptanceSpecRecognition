...
const handleBatchDelete = async () => {
  ...
  if (!hasSelected.value) {
    ElMessage.warning("请先选择要删除的机型");
    return;
  }
  try {
    await ElMessageBox.confirm(
      `确定要删除选中的 ${selectedIds.value.length} 个机型吗？`,
      "批量删除",
    ...
    <el-card class="table-card" shadow="never">
      <template #header>
        <div class="simple-crud-toolbar">
          <span class="simple-crud-toolbar__title">机型列表</span>
      ...
      <div class="table-region">
        ...
        >
          ...
          <el-table-column prop="name" label="机型名称" min-width="min(200px, calc(100vw - 32px))" />
